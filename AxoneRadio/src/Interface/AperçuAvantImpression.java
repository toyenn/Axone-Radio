...
public class AperçuAvantImpression extends javax.swing.JFrame {


    Examen exam;
    public AperçuAvantImpression() {
        this.exam=null;
        initComponents();
    ...
    public void remplirTextArea(){
        this.jTextArea2.setText(exam.InformationsExam());
    }
    ...
    private void initComponents() {
        ...
        jButton2.setText("Fermer l'aperçu ");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        Imprimer imp = new Imprimer(jTextArea2);
        imp.print();
